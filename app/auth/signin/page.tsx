        ...
        <Card>
          ...
          <CardBody className="space-y-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Link
                ...
                className="text-sm text-accent hover:text-accent-2 transition-colors inline-block"
              >
                Forgot password?
              </Link>
          ...
          <CardFooter divider={false}>
            <p className="text-center text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <Link href="/auth/signup" className="text-accent hover:text-accent-2 font-medium transition-colors">
                Sign up
              </Link>
            </p>
          </CardFooter>
